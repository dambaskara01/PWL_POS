...
class SupplierController extends Controller
{
    ...
    {
        $suppliers = SupplierModel::select('supplier_id', 'supplier_kode', 'nama_supplier', 'supplier_alamat');
    ...
    public function export_excel()
    {
        ...
        $barang = SupplierModel::select('supplier_kode', 'nama_supplier', 'supplier_alamat')
    ...
    {
        $supplier = SupplierModel::select('supplier_kode', 'nama_supplier', 'supplier_alamat')
            ->orderBy('supplier_kode')
            ->get();
